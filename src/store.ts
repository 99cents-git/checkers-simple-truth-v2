...
export default new Vuex.Store({
  state: {
    dietFilters: [
      ...
      {code: 9, label: 'No added sugar', name: 'no-added-sugar', selected: false},
      ...
      {code: 7, label: 'Preservative-free', name: 'Preservative-free', selected: false},
      {code: 8, label: 'High Protein', name: 'High-protein', selected: false},
      {code: 10, label: 'GMO-free', name: 'GMO-free', selected: false},
      {code: 12, label: 'No added preservatives', name: 'No-added-preservatives', selected: false},
    ],
    tags: [
